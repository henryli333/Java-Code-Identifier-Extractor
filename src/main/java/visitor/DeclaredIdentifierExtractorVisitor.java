...
public class DeclaredIdentifierExtractorVisitor extends IdentifierExtractorVisitor<Void, ASTIdentifierNode> {
    ...
    public DeclaredIdentifierExtractorVisitor(CompilationUnit compilationUnit, TypeSolver typeSolver) {
